...
def parse_args():
    ...
    assert args.bridge_type in ['VP', 'VE', 'gmax','FM'], 'unsupported bridge type'
    assert args.discriminator_training_strategy in ['frozen_discriminator', 'pretrained_discriminator', 'joint_training','collaborative','none'], 'unsupported discriminator training strategy'
