...
@BackboneRegister.register("ncsnpp_tinny_tinny")
class NCSNpp2M(NCSNpp):
    """Tiny-scale NCSN++ MISB. ~6M parameters"""
...
@BackboneRegister.register("ncsnpp_tinny_tinny_tinny")
class NCSNpp150K(NCSNpp):
    """Tiny-scale NCSN++ MISB. ~6M parameters"""
...
@BackboneRegister.register("ncsnpp_tinny_tinny_tinny_tinny")
class NCSNpp40K(NCSNpp):
    """Tiny-scale NCSN++ MISB. ~6M parameters"""
